...
import 'package:head_x/presentation/product_details/widgets/color_and_desc.dart';
        ...
        children: [
                  ...
                  builder: (context, state) {
                    ...
                    return SizedBox(
                      ...
                      child: CarouselSlider.builder(
                        itemCount: state.productList[index]['images'].length,
                        itemBuilder: (context, indexofEach, realIndex) {
                          final images =
                              state.productList[index]['images'][indexofEach];
                          return Padding(
          ...
          BlocBuilder<ProductListBloc, ProductListState>(
            builder: (context, state) {
              ...
              return ColorAndDesc(value: value);
            },
          )
        ],
      ),
